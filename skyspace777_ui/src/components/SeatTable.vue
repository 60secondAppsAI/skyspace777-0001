...
<template>
  ...
  <base-input label="ClassCategory" type="text" placeholder="Enter ClassCategory" v-model="seatToAdd.classCategory"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'classCategory',
          visible: true,
          scopedSlots: { customRender: 'classCategory' },
          sorter: true
          //sorter: (a, b) => a.classCategory - b.classCategory,
          //sorter: (a, b) => a.classCategory.localeCompare(b.classCategory),
        },
      ],
      pagination: {
        current: 1,
